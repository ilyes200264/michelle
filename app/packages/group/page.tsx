        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-red-50">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-start gap-4 mb-8">
              ...
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl text-green-600">{t("groupPackage")}</h1>
            </div>
              ...
              <div className="space-y-8">
                <div className="rounded-xl border bg-white p-6 shadow-sm">
                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <Button className="w-full bg-red-500 hover:bg-red-600">{t("book")}</Button>
                  </div>
                </div>
                <div className="rounded-xl border bg-white p-6 shadow-sm">
