    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[50vh] bg-gradient-to-r from-primary/20 to-secondary/20">
        <div className="absolute inset-0">
          <Image src="/images/about-hero.jpg" alt="À propos de Frooshy" fill className="object-cover" priority />
          <div className="absolute inset-0 bg-black/40" />
        </div>
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 animate-fade-in">
            {t("about.title", "À propos de Frooshy")}
          </h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">{t("about.values.title", "Nos valeurs")}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">{t("about.values.health.title", "Santé et bien-être")}</h3>
                <p>
                  {t("about.values.health.desc", "Nous croyons que manger sainement peut être délicieux et amusant.")}
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">{t("about.values.sustainability.title", "Durabilité")}</h3>
                <p>
                  {t(
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">{t("about.values.community.title", "Communauté")}</h3>
                <p>
                  {t(
